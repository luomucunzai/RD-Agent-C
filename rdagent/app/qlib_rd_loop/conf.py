...
# CRYPTO_MODE default settings
_CRYPTO_MODE = os.environ.get("CRYPTO_MODE", "").lower() == "true"

if _CRYPTO_MODE:
    _DEFAULT_TRAIN_START = "2024-05-14"
    _DEFAULT_TRAIN_END = "2025-02-15"
    _DEFAULT_VALID_START = "2025-02-16"
    _DEFAULT_VALID_END = "2025-08-15"
    _DEFAULT_TEST_START = "2025-08-16"
    _DEFAULT_TEST_END = "2026-04-20"
else:
    _DEFAULT_TRAIN_START = "2008-01-01"
    _DEFAULT_TRAIN_END = "2014-12-31"
    _DEFAULT_VALID_START = "2015-01-01"
    _DEFAULT_VALID_END = "2016-12-31"
    _DEFAULT_TEST_START = "2017-01-01"
    _DEFAULT_TEST_END = "2020-08-01"


_CRYPTO_DEFAULTS = {
    "train_start": _DEFAULT_TRAIN_START,
    "train_end": _DEFAULT_TRAIN_END,
    "valid_start": _DEFAULT_VALID_START,
    "valid_end": _DEFAULT_VALID_END,
    "test_start": _DEFAULT_TEST_START,
    "test_end": _DEFAULT_TEST_END,
}
...
class ModelBasePropSetting(BasePropSetting):
    ...
    train_start: str = _CRYPTO_DEFAULTS["train_start"]
    """Start date of the training segment"""

    train_end: str = _CRYPTO_DEFAULTS["train_end"]
    """End date of the training segment"""

    valid_start: str = _CRYPTO_DEFAULTS["valid_start"]
    """Start date of the validation segment"""

    valid_end: str = _CRYPTO_DEFAULTS["valid_end"]
    """End date of the validation segment"""

    test_start: str = _CRYPTO_DEFAULTS["test_start"]
    """Start date of the test / backtest segment"""

    test_end: Optional[str] = _CRYPTO_DEFAULTS["test_end"]
